...
<html lang="en">
    ...
    <body>
        ...
        <main class="container">
            ...
            <p></p>
			<a href="sampling_history.php"><button class="btn btn-block btn-primary" type="button">Clipping BG Removal History <i class="fas fa-external-link-alt"></i></button></a>
